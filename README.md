...
<div id="frontPage" class="card">
  ...
  <button onclick="viewDashboard(false, false)" style="background:#555">Public Dashboard</button>
</div>
...
<div id="bmiPage" class="card" style="display:none;">
  ...
  <button onclick="viewDashboard(false, false)" style="background:#ff9ec4;">Public Dashboard</button>
...
function calculateBMI() {
  ...
  if(!h || !w) { alert("Enter both values!"); return; }
...
function viewDashboard(isAdmin, isUserOnly) {
  showPage('dashboardPage');
  document.getElementById('dashTitle').innerText = isUserOnly ? "My Personal Records" : "Records Dashboard";
